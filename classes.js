...
class ProgressiveManager {
  ...
  updateTitle() {
    ...
    else if(this.reports.length >= 51) {this.title = "Manager Plus"}
    else if(this.reports.length >= 11) {this.title = "Manager"}
    else if(this.reports.length >= 4) {this.title = "Mostly Manager"}
    else if(this.reports.length >= 1) {this.title = "Barely Manager"}
    else if(this.reports.length >= 0) {this.title = "Not a Manager"}
  }
}
